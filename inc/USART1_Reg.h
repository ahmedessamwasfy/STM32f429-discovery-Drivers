...
#define RCC_APB2ENR   (0x40000000+0x00020000+0x3800+0x30) /*!< RCC APB2 peripheral clock enable register, Address offset: 0x44 */
...
#define RCC_APB2ENR   (0x40000000+0x00020000+0x3800+0x44) /*!< RCC APB2 peripheral clock enable register, Address offset: 0x44 */

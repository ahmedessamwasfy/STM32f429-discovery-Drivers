...
#define DMA2_CR(stream)  				*((volatile uint32*) 0x10+0x18*stream+DMA2_BASE)    /*!< DMA stream x configuration register      */
#define DMA2_NDTR(stream)				*((volatile uint32*) 0x14+0x18*stream+DMA2_BASE)    /*!< DMA stream x number of data register     */
#define DMA2_PAR(stream)				*((volatile uint32*) 0x18+0x18*stream+DMA2_BASE)    /*!< DMA stream x peripheral address register */
#define DMA2_M0AR(stream)				*((volatile uint32*) 0x1C+0x18*stream+DMA2_BASE)    /*!< DMA stream x memory 0 address register   */
#define DMA2_M1AR(stream)				*((volatile uint32*) 0x20+0x18*stream+DMA2_BASE)    /*!< DMA stream x memory 1 address register   */
#define DMA2_FCR(stream)				*((volatile uint32*) 0x24+0x24*stream+DMA2_BASE) 	 /*!< DMA stream x FIFO control register       */
...
#define DMA_LIFCR_CTEIF2                     ((uint32)0x00080000)
